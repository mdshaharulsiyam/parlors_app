...
const ServicesCreateUpdateForm = () => {
  ...
  const {categories, subCategories, isLoading} = useCategoriesApiCall({
    categorySearch,
    subCategorySearch,
          ...
          return (
            <View key={key}>
              ...
              <SingleSelectDropDown
                ...
                onChangeText={
                  key === 'category' ? setCategorySearch : setSubCategorySearch
                }
        ...
        if (key === 'img') {
          return (
            <View key={key}>
              ...
              <ImageUpload images={img} setImages={setImg}>
                <View
                  style={[
                    globalStyles.inputLabel,
                    {
              ...
              <TextInput
                ...
                style={[
                  globalStyles.input,
                  {
                    ...
                    borderWidth: error[key as keyof IServicesInputError]
                      ? 1
                      : 0,
                    backgroundColor: hexToRGBA(
                      themeColors.black as string,
